...
enum L10n {
    ...
    static let closestTokyoStations = String(localized: "Closest Tokyo Stations")
    static let tokyoStations = String(localized: "Tokyo Stations")
    ...
    static let tokyoStationsLoadFailed = String(localized: "Tokyo stations could not be loaded.")
